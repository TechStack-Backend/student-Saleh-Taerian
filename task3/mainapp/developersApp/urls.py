...
from .views import projectCreateView , developerCreateView , developerListView , projectListview , skillCreateView , developerDetail ,deleteProject , deleteSkill , deleteDeveloper ,updateDeveloper , updateProject , updateSkill
urlpatterns = [
